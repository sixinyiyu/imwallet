...
export async function runSeed(): Promise<void> {
  try {
    ...
    const assetsData = [
      ...
      { id: "asset-eth-ethereum",  symbol: "ETH",  name: "Ethereum",   decimals: 18, chain: ChainType.Ethereum, type: TokenType.NATIVE,     tokenId: "",                                              isDefault: true, isActive: false, isTradable: false },
      { id: "asset-usdt-ethereum", symbol: "USDT", name: "Tether USD", decimals: 6,  chain: ChainType.Ethereum, type: TokenType.TOKEN,      tokenId: "0xdAC17F958D2ee523a2206206994597C13D831ec7",      isDefault: true, isActive: false, isTradable: false },
      { id: "asset-btc-bitcoin",   symbol: "BTC",  name: "Bitcoin",    decimals: 8,  chain: ChainType.Bitcoin,  type: TokenType.NATIVE,     tokenId: "",                                              isDefault: true, isActive: false, isTradable: false },
    ];
    ...
    if (!existingTxRestrict) {
      await prisma.appConfig.create({
        data: { key: "tx_restrict_wallet", value: "true" },
      });
      logger.info("SEED", "已创建 tx_restrict_wallet 配置项: true");
    }
